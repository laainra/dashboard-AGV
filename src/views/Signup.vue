<template>
  ...
  <main class="main-content mt-0">
    <div
      class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg bg-image"
    >
        ...
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">
              Use these awesome forms to login or create new account with this
              dashboard to see awesome project for AGV Lidar with Karakuri
            </p>
          </div>
        </div>
      </div>
